  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 py-8 md:py-12">
        ...
        <section className="mb-8">
          ...
          {!isDone && (
            <div className="text-center mb-8">
              ...
              <p className="text-muted text-lg max-w-xl mx-auto">
                Search any professional football player to get an AI-powered market
                valuation with detailed analysis and comparable transfers.
              </p>
            </div>
          )}

          <SearchBar onSelect={handlePlayerSelect} disabled={isLoading} />
          ...
          <div className="max-w-2xl mx-auto mt-3">
            ...
            >
              ...
              {showOptional ? "Hide" : "Add"} salary &amp; contract data (optional, improves
              accuracy)
            </button>
        ...
        {/* ── Result ───────────────────────────────────────────────── */}
        {isDone && <ValuationResult player={player} valuation={valuation} />}
            ...
            {[
              {
                ...
                desc: "Over 300,000 players from 1,000+ leagues worldwide",
              },
              {
                icon: "📊",
